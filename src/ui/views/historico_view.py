...
class HistoricoView(ctk.CTkFrame):
    ...
    def _build(self):
        ...
        ctk.CTkButton(tb, text="↻ Atualizar", width=104, height=34, corner_radius=12, fg_color=c["surface_elevated"], text_color=c["text"], border_width=1, border_color=c["border"], command=self.refresh).pack(side="right")
        self.card = card(self)
